...
public interface WorkFillDAO {
    ...
    String INSERT_FILEDS = "projectName,college,competitonType,studentName,studentNumber,birthDay,education,major," +
    ...
    ") values (#{projectName}, #{college}, #{competitonType}, #{studentName}, #{studentNumber}, #{birthDay}, " +
